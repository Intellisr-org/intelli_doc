...
class Settings(BaseSettings):
    ...
    ENABLE_EFFICIENT_ATTENTION: bool = False # Usually keep True, but if you get CUDA errors, setting to False can help
    ...
    # Text recognition
    RECOGNITION_MODEL_CHECKPOINT: str = "../intellidoc/rec2"
    ...
    # Layout
    LAYOUT_MODEL_CHECKPOINT: str = "intellidoc/layout3"
