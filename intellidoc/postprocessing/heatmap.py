...
from intellidoc.postprocessing.util import rescale_bbox
from intellidoc.schema import PolygonBox
from intellidoc.settings import settings
from intellidoc.postprocessing.text import get_text_size
