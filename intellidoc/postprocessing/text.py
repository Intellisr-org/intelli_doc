...
from intellidoc.postprocessing.fonts import get_font_path
from intellidoc.schema import TextLine
from intellidoc.settings import settings
from intellidoc.postprocessing.math.latex import is_latex
...
def render_math(image, draw, text, s_bbox, bbox_width, bbox_height, font_path):
        try:
            from intellidoc.postprocessing.math.render import latex_to_pil
