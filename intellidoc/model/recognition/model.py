...
from intellidoc.model.recognition.encoderdecoder import OCREncoderDecoderModel
from intellidoc.model.recognition.config import DonutSwinConfig, SuryaOCRConfig, SuryaOCRDecoderConfig, SuryaOCRTextEncoderConfig
from intellidoc.model.recognition.encoder import DonutSwinModel
from intellidoc.model.recognition.decoder import SuryaOCRDecoder, SuryaOCRTextEncoder
...
if not settings.ENABLE_EFFICIENT_ATTENTION:
    ...
    # Only configure CUDA SDPA if CUDA is available
